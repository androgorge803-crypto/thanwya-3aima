...
// ── Love Messages ─────────────────────────
const LOVE_MSGS = [
`يا <span class="highlight">Karen</span> 🤍<br>عارف إن الأيام دي صعبة شوية، بس أنا متأكد إنك قدها. خديها خطوة خطوة ومتقلقيش، كل تعبك هتشوفي نتيجته قدامك.`,

`يا كارن 🌸<br>بس حبيت أفكرك إنك شاطرة أكتر ما أنتِ متخيلة. متخليش أي امتحان يخوفك، أنتِ ذاكرتي وتعبتي وربنا مش هيضيع تعبك.`,

`يا حبيبتي 📚<br>لما تحسي إنك تعبانة من المذاكرة افتكري إن كل صفحة بتخلصيها بتقربك من اللي نفسك فيه. كملي وأنا فخور بيكي.`,

`Karen 🤍<br>متضغطيش نفسك زيادة. اعملي اللي عليكي والباقي سيبيه على ربنا. أهم حاجة تفضلي واثقة في نفسك.`,

`يا أجمل واحدة 🌷<br>أنا عارف قد إيه أنتِ بتتعبي وبتحاولي، وعشان كده متأكد إن ربنا هيكرمك بحاجة تفرح قلبك.`,

`يا كارن ✨<br>كل يوم بتكمليه في المذاكرة هو إنجاز لوحده، حتى لو حاسة إنك مقصرة. كملي بس ومتبصيش لورا.`,

`يا حبيبتي 💕<br>أنا مش مستني منك غير إنك تعملي اللي تقدري عليه. النتيجة بتاعة ربنا، لكن المجهود اللي بتعمليه ده حاجة تفرح.`,

`Karen 🌹<br>وقت الامتحانات بيعدي أسرع ما الواحد متخيل، شدي حيلك كام يوم كده وبعدها ترتاحي وتفرحي بتعبك.`,

`يا روحي 🤍<br>لو يوم كان صعب عليكي أو مذاكرتيش زي ما كنتِ عايزة، عادي. قومي اليوم اللي بعده وكملي وكأن مفيش حاجة حصلت.`,

`يا كارن 📖<br>أنا بحب فيكي إنك مبتستسلميش بسهولة، ودي لوحدها ميزة هتخليكي تنجحي في أي حاجة تعمليها.`,

`حبيبتي 🌸<br>متقارنيش نفسك بحد. ركزي في طريقك أنتِ بس، وكل خطوة بتاخديها دلوقتي ليها قيمة.`,

`Karen 💗<br>أنا واثق فيكي بجد، ومش كلام تشجيع وخلاص. لأنك كل مرة بتعدي حاجة صعبة بتثبتي إنك أقوى مما تتخيلي.`,

`يا جميلة 🤍<br>خدي نفس، رتبي يومك، وابدئي. أصعب حاجة هي البداية، وبعدها كل حاجة بتمشي واحدة واحدة.`,

`يا كارن 🎓<br>عارف إنك نفسك تخلصي الفترة دي، وهتخلص فعلًا. المهم دلوقتي تركزي في كل يوم لوحده.`,

`حبيبتي ✨<br>ربنا شايف تعبك وسهرك ومجهودك، ومفيش حاجة من ده بتضيع. كملي بس ومتخافيش.`,

`Karen 🌷<br>مهما حسيتِ إن المنهج كبير، افتكري إنك خلصتي حاجات أصعب قبل كده. وهتعمليها تاني.`,

`يا روحي 💕<br>أنا مبسوط بيكي سواء كان يومك حلو أو وحش. المهم متوقفيش وتحاولي كل يوم شوية.`,

`يا كارن 🤍<br>وقت الامتحان اقري السؤال بهدوء وخدي وقتك. أنتِ فاهمة أكتر ما التوتر بيحاول يقنعك.`,

`حبيبتي 📚<br>متنسيش ترتاحي وتشربي مية وتأكلي كويس. المذاكرة مهمة، بس أنتِ أهم.`,

`Karen 🌸<br>كل مرة بتفتحي الكتاب رغم التعب دي لوحدها حاجة تستحق التقدير. فخورة بيكي جدًا.`,

`يا أجمل كارن 💗<br>ربنا يريح قلبك ويطمنك ويكتبلك الخير في كل امتحان ويكرمك على قد تعبك.`,
...
`يا كارن 🌷<br>شدي حيلك شوية كمان، الأيام دي هتتحول قريب لذكريات وهتضحكي عليها.`,

`حبيبتي 💕<br>كل ما تتعبي افتكري ليه بدأتي من الأول، وافتكري قد إيه أنتِ قريبة من هدفك.`,

`Karen 📖<br>أنا مؤمن بقدراتك أكتر ما تتخيلي، وعارف إنك هتعملي اللي عليكي وزيادة.`,

`يا روحي 🌸<br>خلي عندك ثقة إن ربنا مدبر كل حاجة، وإنتِ اعملي اللي عليكي والباقي عليه.`,
...
`يا كارن 💗<br>أنا بحب أشوفك بتحققي اللي نفسك فيه، وعشان كده بشجعك تكملي للنهاية.`,

`حبيبتي 🌷<br>خليكي هادية وواثقة، لأن التوتر بيخوف أكتر من الامتحان نفسه.`,

`Karen 🤍<br>مفيش حد كامل، ومفيش حد بيحل كل حاجة صح. اعملي أفضل ما عندك وخلاص.`,

`يا روحي 📚<br>ربنا يقويكي ويثبتك ويفرح قلبك بالنتيجة اللي تتمنيها.`,
...
`Karen 💗<br>يلا كملي، قربتي تخلصي. وربنا يكرمك ويفرح قلبك على قد تعبك بالظبط.`
];
