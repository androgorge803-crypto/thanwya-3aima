...
// ── Daily Gifts ───────────────────────────
const GIFTS = [
  { emoji: '🍫', name: 'شوكولاتة كاديبري',         desc: 'لأن كل حاجة حلوة تفكرك بيكِ يا أحلى حاجة في حياتي 🍫' },
  { emoji: '🍪', name: 'بسكويت وشوكولاتة',          desc: 'تشيلي بالبسكويت وانتِ بتذاكري وتفتكري بيا 🥰' },
  { emoji: '🧁', name: 'كب كيك بالكريمة',           desc: 'زي ما انتِ حلوة على قلبي، الكب كيك ده حلاوته زيك 🎀' },
  { emoji: '🍓', name: 'فراولة بالشوكولاتة',         desc: 'الفراولة الحمرة دي بتفكرني بحبي ليكِ 💗' },
  { emoji: '🧃', name: 'عصير مانجو',                desc: 'عشان تفضلي منعشة وبتذاكري وقلبك رايق 🌿' },
  { emoji: '🍬', name: 'حلوى هاربو',                desc: 'حياتي معاكِ زي الحلوى، كل يوم بيحلى أكتر 🍭' },
  { emoji: '🎂', name: 'تورتة مبروكة',              desc: 'مبروك على كل حاجة جميلة فيكِ يا Karen 🎉' },
  { emoji: '🍩', name: 'دونات بالسكر',              desc: 'زي دايرة الحب، ملهاش أول ولا آخر 💝' },
  { emoji: '🫶', name: 'عناق افتراضي',              desc: 'لو الهديه مش حاجة تتاكل، خدي من عندي أحر عناق 🤍' },
  { emoji: '🌹', name: 'وردة حمرا',                 desc: 'كل وردة على الأرض بتفكرني بيكِ يا Karen 🌹' },
  { emoji: '🍦', name: 'آيس كريم فراولة',            desc: 'بنفس اللون الوردي زي ابتسامتك يا حبيبتي 🌸' },
  { emoji: '🧇', name: 'وافل بالكريمة والفراولة',    desc: 'لأن الصبح مش حلو غيرك 🌅' },
  { emoji: '☕', name: 'كوكاو ساخن',                desc: 'عشان يدفيكِ وانتِ بتذاكري زي ما حبك بيدفيني 💛' },
  { emoji: '🍰', name: 'سلايس تشيز كيك',            desc: 'لأنك تستاهلي أحلى حاجة في الدنيا كلها 🤍' },
];
